...
\begin{itemize}
    ...
    \item Desenvolver uma sistema para auxiliar na parametrizacão do algoritmo de detecção, buscando melhor otimização para cada cena e dispositivo, e na obtenção das métricas de desempenho.
