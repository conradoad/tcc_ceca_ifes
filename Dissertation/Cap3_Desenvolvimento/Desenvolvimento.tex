...
Nessa segunda cena, como o objetivo é a detecção de uma única face mais próxima da câmera e permancendo por muito pouco tempo no campo de visão, trona-se então menos importante a qualidade da imagem e mais importante a vaelocidade comque os frames são disponibilizados.

Outro \emph{port} de captura disponível é o \emph{video port} ...
...
\subsubsection{Variações de resolução}
