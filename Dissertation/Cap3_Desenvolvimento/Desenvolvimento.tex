...
Para obtenção das imagens, bem como os tempos médios de captura, foi escrito um script simples para capturar 30 frames em sequência, salvando os mesmos em arquivos de formato JPEG e calculando os tempos médios apenas da captura desses frames, para cada resolução diferente, que serão utilizados na base de dados para comparação. O mesmo script foi utilizado para obter as duas imagens na resolução 800x600 a serem utilizadas na ferramenta de parametrização. 
